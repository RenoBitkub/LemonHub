...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://117977400096834",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=108623185605906";
v24.Parent = v23;
...
local v49 = v16.Main:AddToggle("ToggleLevel", {
    Title = "Farm Level",
    Description = "⚠️ Warning: It Can Be Error, If Error Occurs During Use, Please Turn It On With Aura Farm",
    Default = false
});
...
local v50 = v16.Main:AddToggle("ToggleMobAura", {
    Title = "Aura Farm",
    Description = "⚠️ If Farm Level is Error You Can Enable This Feature And Enable It Along With Farm Level",
    Default = false
});
...
local v51 = v16.Main:AddToggle("ToggleCastleRaid", {
    Title = "Pirate Raid",
    Description = "At the Fortress on the Sea",
    Default = false
});
...
local v52 = v16.Main:AddToggle("ToggleHakiFortress", {
    Title = "Turn On All 3 Colors of Haki",
    Description = "Red, White, Pink To Summon rip_indra",
    Default = false
});
...
local v55 = v16.Main:AddToggle("ToggleCollectChest", {
    ...
    Description = "⚠️Warning: Level May Be Reset Or Items May Even Be Banned",
    Default = false
});
...
if Sea3 then
    ...
    local v494 = v16.Main:AddToggle("ToggleDoughKing", {
        Title = "Super Fast Hit Dough King",
        Description = "Sea 3",
        Default = false
    });
...
if Sea3 then
    ...
    local v502 = v16.Sea:AddToggle("ToggleCollectAzure", {
        Title = "Pick Up the Flame of Revenge",
        Description = "",
        Default = false
    });
...
if Sea3 then
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v594 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "Lemon Hub",
                    Content = "Lava Island Found Please Pay Attention⚠️",
                    Duration = 10
                });
                v513 = true;
            end
    ...
    local v514 = v16.Sea:AddToggle("AutoFindMirage", {
        Title = "Finding the Mysterious Island",
        Description = "",
        Default = false
    });
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v605 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "Lemon Hub",
                    Content = "The Mysterious Island Found🏝️",
                    Duration = 10
                });
                v513 = true;
            end
    ...
    local v515 = v16.Sea:AddToggle("AutoFindFrozen", {
        Title = "Auto Go Leviathan",
        Description = "Need 5 Players Without Idk",
        Default = false
    });
    ...
    local v516 = v16.Sea:AddToggle("AutoComeTiki", {
        Title = "Sailing Back to Tiki",
        Description = "⚠️ May be buggy and not recommended for use.",
        Default = false
    });
...
if Sea3 then
    ...
    local v532 = v16.Sea:AddParagraph({
        Title = "Mysterious Island Status",
        Content = ""
    });
    task.spawn(function()
        while task.wait() do
...
local v68 = v16.Sea:AddToggle("Togglelockmoon", {
    ...
    Description = "⚠️ Requirements: Have Mirror Piece, Defeat rip_indra, Do Quests at the Fortress",
    Default = false
});
...
local v158 = v16.Sea:AddToggle("ToggleReceiveQuest", {
    ...
    Description = "⚠️Turn it on once and you will receive one more, then turn it off and turn it on again",
    Default = false
});
